    ...
    return (
        <HomeLayout>
            <div className="min-h-[90vh] flex items-center justify-center ">
                <div className="my-10 flex flex-col gap-4 rounded-lg p-4 text-white w-100 shadow-[0_0_10px_gray]">
                    <img 
                      ...
                      <div className="flex items-center justify-between gaP-2">
                        <Link 
                            to="/changepassword" className="w-48 bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300 rounded-sm font-semibold py-2 cursor-pointer text-center">
