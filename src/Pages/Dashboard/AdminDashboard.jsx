import {ArcElement,BarElement,CategoryScale,Chart as ChartJS,Legend ,LinearScale,Title,Tooltip } from "chart.js";//to make chart like as pie chart
                ...
                <div className="grid grid-cols-2 gap-5 m-auto mx-10 ">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow">
                                <div className="flex flex-col items-center ">
                                    <p className="font-bold">Registred Users</p>
                                    <h3 className="text-4xl font-bold pr-6">{allUsersCount}</h3>
                            ...
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow">
                                <div className="flex flex-col items-center ">
                                    <p className="font-bold">Subscribesd Users</p>
                                    <h3 className="text-4xl font-bold pr-6">{subscribedCount}</h3>
                    ...
                    <div className="flex flex-col items-center gap-10 p-5 shadow-lg rounded-md">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow">
                                    <div className="flex flex-col items-center ">
                                        <p className="font-bold">Subscription Count</p>
                                        <h3 className="text-4xl font-bold pr-6">{allPayments?.count}</h3>
                                    </div>
                                ...
                                <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow">
                                    <div className="flex flex-col items-center ">
                                        ...
                                        <h3 className="text-4xl font-bold pr-6">{allPayments?.count *499}</h3>
                                    </div>
